...
if !exists('g:clojure_highlight_extra_defs')
    let g:clojure_highlight_extra_defs = []
endif

if !exists('g:clojure_highlight_extra_exceptions')
...
for name in g:clojure_highlight_extra_defs
    execute 'syntax keyword clojureDefine ' . name
endfor

for name in g:clojure_highlight_extra_exceptions
    execute 'syntax keyword clojureException ' . name
endfor
